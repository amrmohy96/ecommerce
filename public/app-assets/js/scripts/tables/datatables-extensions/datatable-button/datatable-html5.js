/*=========================================================================================
    File Name: datatables-html5.js
    Description: HTML 5 Datatable
    ----------------------------------------------------------------------------------------
...
$(document).ready(function () {
    ...
    $('.dataex-html5-message').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'pdfHtml5',
    ...
    $('.dataex-html5-orientation').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'pdfHtml5',
    ...
    /**********************************************
     *       js of PDF - open in new window        *
     **********************************************/

    $('.dataex-html5-window').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'pdfHtml5',
    ...
    /****************************************
     *       js of Custom file (JSON)        *
     ****************************************/

    $('.dataex-html5-json').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                text: 'JSON',
