            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__('site.edit_user')}}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card bg-gradient-x2-black">
                    <div class="card-header">
                        <h4 class="card-title">{{__('site.edit_user')}}</h4>
                    </div>
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form id="myForm" action="{{route('users.update',$user->id)}}"
                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->product == 1 ? 'checked' : '' }} value="1" name="product"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->order == 1 ? 'checked' : '' }} value="1" name="order"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->category == 1 ? 'checked' : '' }} value="1" name="category"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->coupon == 1 ? 'checked' : '' }} value="1" name="coupon"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->brand == 1 ? 'checked' : '' }} value="1" name="brand"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" {{$user->role == 1 ? 'checked' : '' }} value="1" name="role"
