<template>
    <div class="dropdown" style="float: right; padding: 13px">
        <a aria-expanded="true" data-target="#" data-toggle="dropdown" href="#" id="dropdownMenu1" onclick="return false;"
           role="button" style="float: left">
            <i class="fa fa-bell-o" style="font-size: 20px; float: left; color: black">
            </i>
        </a>
        <span class="badge badge-danger">6</span>
        <ul aria-labelledby="dropdownMenu1" class="dropdown-menu dropdown-menu-left pull-right" role="menu">
            <li role="presentation">
                <a class="dropdown-menu-header" href="#">Notifications</a>
            </li>
            ...
            <li role="presentation">
                <a class="dropdown-menu-header" href="#"></a>
            </li>
        </ul>
    </div>
</template>
